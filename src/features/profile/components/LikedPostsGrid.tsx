/**
 * LikedPostsGrid Component
 * 
 * Grid for liked posts with heart overlay icon
 */
...
export const LikedPostsGrid: React.FC<LikedPostsGridProps> = ({
    posts,
    isLoading,
    onPostPress,
}) => {
                            ...
                            >
                                ...
                                >
                                    ...
                                    <View style={styles.heartOverlay}>
                                        <Ionicons name="heart" size={20} color="#ED4956" />
                                    </View>
                                </TouchableOpacity>
                            </Animated.View>
                        );
